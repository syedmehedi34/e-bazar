      ...
      <div className="container-custom my-10 rubik">
        <div className="grid md:grid-cols-2">
          ...
          <form
            ...
            className="border border-gray-300 dark:border-gray-600 md:p-8 p-4"
          >
            <div className="flex justify-center items-center my-10">
              <p className="text-xl font-bold tracking-wide dark:text-white">
                Send Your Message
              </p>
            </div>
            ...
            <div className="mb-6">
              <label className="relative block">
                ...
                />
                <p className="absolute top-[50%] translate-y-[-50%] left-3 dark:text-white">
          ...
          <div className="border border-gray-300 dark:border-gray-600 dark:text-white md:p-16 p-8 ">
            <div className="flex gap-5 mb-10">
              ...
              <div className="">
                ...
                <p className="text-gray-600 tracking-wide dark:text-gray-200">
                  E-Catalog Industries Ltd.
                </p>
                <p className="text-gray-600 tracking-wide dark:text-gray-200">
                  Dhanmondi 04, Dhaka , 1208 BD
                </p>
              </div>
            </div>
            <div className="flex gap-5 mb-10">
