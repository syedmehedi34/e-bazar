        ...
        <section className="grid lg:grid-cols-2 gap-10 ">
          ...
          <div className="space-y-4">
            <h1 className="text-2xl md:text-3xl font-bold mb-4 border-l-4 border-gray-900 dark:border-white pl-3">
              Our Story – The Journey of E-Catalog
            </h1>
            <article className="space-y-4 leading-relaxed text-gray-700 dark:text-gray-300">
              <p>
                ...
                space, it started as a simple dream — a dream to make online
                shopping easier, safer, and more reliable for everyone.
              </p>
              <p>
                The story of E-Catalog began with a small but passionate team of
                ...
                deliveries, and lack of trust. That’s when the idea of E-Catalog
                was born — to bridge the gap between quality and convenience.
              </p>
              <p>
                From day one, E-Catalog’s mission was clear: to deliver
                authentic products at fair prices with a seamless shopping
                experience. The founders spent months researching customer
                behavior, studying product quality, and building strong
                relationships with trusted suppliers. Every decision was driven
                by one question — “How can we make our customers’ online
                shopping experience better?”
              </p>
              <p>
                In the early days, E-Catalog started small — with just a few
                ...
                appears on E-Catalog goes through a strict quality check,
                ensuring customers receive nothing but the best.
              </p>
              <p>
                Today, E-Catalog stands as a growing e-commerce ecosystem that
                ...
                E-Catalog not only a shopping platform but also a digital
        ...
        <section className="grid lg:grid-cols-2 gap-10 items-center rubik text-gray-800 dark:text-gray-200">
          ...
          <div className="space-y-4 order-1 md:order-2">
            ...
            <article className="space-y-4 leading-relaxed">
              ...
              <p>
                We are committed to creating an ecosystem that connects
                customers directly with authentic brands and verified sellers.
                Every product listed on E-Catalog is carefully reviewed to
                ensure quality and value. From fashion and electronics to daily
                essentials, our goal is to offer everything our customers need —
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Build Trust:</strong> Create a reliable platform where
                customers can shop with confidence; every product is authentic
                and verified.
              </li>
              <li>
                <strong>Ensure Quality:</strong> Offer only high-quality
                products from trusted brands and suppliers, ensuring real value
                for money.
              </li>
              <li>
                <strong>Empower Local Sellers:</strong> Support small and local
                businesses by giving them digital visibility and growth
                opportunities.
              </li>
              <li>
                <strong>Enhance Convenience:</strong> Provide a seamless
                shopping experience with fast delivery, easy returns, and secure
                payments.
              </li>
              <li>
                <strong>Innovate Continuously:</strong> Use modern technology to
                improve the user experience — from smart recommendations to
                responsive design.
              </li>
              <li>
                <strong>Customer Satisfaction First:</strong> Act on feedback
                and constantly improve our services to meet customer needs.
              </li>
              <li>
                <strong>Transparency & Integrity:</strong> Operate with honesty
                and openness in every step — from pricing to delivery.
              </li>
              <li>
                <strong>Sustainability:</strong> Encourage ethical practices and
          ...
          <div className="relative order-2 md:order-1 flex justify-center">
            <div className="relative">
              {" "}
              <Image
                src="https://img.freepik.com/free-photo/people-sharing-ideas-while-studying_23-2147656100.jpg?t=st=1760092036~exp=1760095636~hmac=5001107f4dc19daab17a83e19343f657f0393cb2caf71e79ef1cec658f1f7526&w=2000"
                width={600}
                height={400}
                alt="Our Story"
                className="rounded-2xl shadow-md w-[100%] lg:w-[90%] object-cover "
              />{" "}
            </div>
          </div>
        </section>
