...
const CheckoutDetails: React.FC<CheckoutDetailsProps> = ({
  ...
  return (
    <div className="rubik dark:text-white max-md:flex max-md:flex-col justify-center items-center ">
      <h2 className="text-3xl font-semibold mb-4 max-md:text-center">
        {products?.title}
      </h2>
      <p className="mb-2 flex items-center">
        {[...Array(Math.floor(Number(products?.rating) || 0)).keys()].map(
          (i) => (
      ...
      {/* Price */}
      <div className="text-xl font-bold mb-2 flex items-center gap-4">
        ...
        <div className="flex  my-2 gap-4  ">
          <div className="flex items-center border gap-2  border-gray-300 dark:border-gray-600 ">
            <button
              ...
              className="btn dark:bg-gray-700 dark:border-gray-600 dark:text-white  btn-square"
            >
              -
            </button>
            ...
            <button
              ...
              className="btn btn-square dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            >
              +
            </button>
          </div>
      ...
      <div className="flex gap-4 mt-6">
        <Button
          action={() => handledTwoCartItem(products)}
          text={"Add to Cart"}
        />
