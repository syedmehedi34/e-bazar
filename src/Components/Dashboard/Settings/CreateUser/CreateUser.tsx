    ...
    <div>
      <div>
        ...
        <p className="mb-4 text-gray-600 dark:text-gray-300">
          This section allows administrators to create new users by providing
          their name, email, password, and role. Once created, the new user will
          be added to the system and displayed in the user list.
        </p>
